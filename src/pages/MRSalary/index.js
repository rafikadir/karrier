...
import img1 from "../../assets/images/Pictures/salary/mr-job-salary.jpg";
...
function MRSalary() {
	return (
		<>
			<Helmet>
				<title>MR job salary & career growth - best career option - KARRIER</title>
				<meta name="description" content="The salary of a medical representative is 2.80 lacs/annum which is higher than a fresh engineer graduate's 1.70 lacs. Best Training Institute ⭐⭐⭐⭐⭐"/>
